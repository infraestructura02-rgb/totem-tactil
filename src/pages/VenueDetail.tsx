  ...
  if (!venue) {
    return (
      <div id="venue-not-found" className="flex-1 flex flex-col items-center justify-center p-8 bg-slate-50 text-center">
        <h2 className="font-sans text-2xl font-bold text-gray-900 mb-2">Salón No Encontrado</h2>
        <p className="font-sans text-gray-600 mb-6">El espacio solicitado no se encuentra cargado en el sistema.</p>
        <Link
          id="btn-back-to-catalog"
          to="/salones"
          className="rounded-xl bg-[#004B75] px-6 py-2.5 font-sans text-sm font-semibold text-white hover:bg-[#003B5C]"
        >
          Regresar al Catálogo de Salones
        </Link>
      </div>
    );
  }
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <section className="lg:col-span-7 space-y-6">
            <div className="bg-white p-6 rounded-2xl border border-gray-150 shadow-xs">
              <VenueGallery images={venue.gallery} title={venue.name} />
            ...
            <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-[#004B75] to-[#003B5C] p-8 text-white border-b-4 border-[#1E88C8] shadow-md">
              ...
              <div className="relative z-10 max-w-md">
                ...
                <h3 className="font-sans text-xl font-bold">
                  ¿Desea explorar este salón en 3D?
                </h3>
                
                <p className="mt-2 font-sans text-xs text-blue-100/90 leading-relaxed">
                  Active nuestro escáner interactivo Matterport en pantalla completa para caminar por el salón, ver las perspectivas y planear su evento estratégicamente con gestos touch.
                </p>

                <button
                  id="btn-active-matterport-details"
                  onClick={() => setActive3dUrl(venue.matterportUrl)}
                  className="mt-5 inline-flex items-center gap-2.5 rounded-xl bg-amber-500 hover:bg-amber-600 px-6 py-3.5 font-sans text-xs font-black text-white shadow-lg active:scale-95 transition"
                >
                  <Compass className="h-4.5 w-4.5 animate-spin-slow" />
                  Iniciar Recorrido Virtual en Fullscreen
                </button>
              </div>
            </div>
          </section>
          ...
          <aside className="lg:col-span-5 space-y-6">
            ...
            <div className="bg-white p-6 rounded-2xl border border-gray-150 shadow-xs">
              <h3 className="font-sans text-sm font-extrabold text-[#003B5C] uppercase tracking-wider border-b border-gray-100 pb-3 mb-4">
                Capacidad según Tipo de Montaje
              </h3>
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div className="text-left font-sans text-xs">
                        <span className="block font-bold text-gray-900">{setup.type}</span>
                        <span className="block text-[10px] text-gray-400 mt-1 uppercase font-medium">Recomendado</span>
                      </div>
                    </div>
            ...
            <div className="bg-gradient-to-br from-white to-gray-50 p-6 rounded-2xl border border-gray-150 shadow-xs text-left">
              ...
              <div className="mt-3 pt-3 border-t border-gray-100 text-[10px] font-mono text-gray-400 uppercase tracking-wider">
                Servicio Gourmet de Coffee Break Disponible a Solicitud
              </div>
            </div>
