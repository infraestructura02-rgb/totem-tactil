        ...
        <div className="mb-8 flex flex-col md:flex-row md:items-end justify-between gap-4">
          <div>
            ...
            <h1 className="font-sans text-3xl font-extrabold text-[#003B5C] tracking-tight">
              Nuestros Dignos Salones
            </h1>
            <p className="font-sans text-sm text-gray-500 mt-1 max-w-2xl">
              Diseño modular y premium adaptado a convenciones académicas, banquetes conmemorativos, juntas de alta dirección y lanzamientos corporativos en Bogotá.
            </p>
          </div>
              ...
              >
                ...
                <div className="relative aspect-video w-full overflow-hidden bg-gray-100">
                  ...
                  <button
                    ...
                    onClick={(e) => trigger3dTour(venue.matterportUrl, venue.name, e)}
                    className="absolute bottom-4 right-4 flex items-center gap-2 rounded-xl bg-amber-500 hover:bg-amber-600 px-4 py-3 font-sans text-xs font-bold text-white shadow-lg active:scale-90 transition"
                  >
                ...
                <div className="p-6 flex-1 flex flex-col justify-between">
                  <div>
                    ...
                    <div className="mt-5">
                      <span className="font-sans text-[10px] font-extrabold text-blue-900/60 uppercase tracking-widest block mb-2">
                        Equipamiento Premium Destacado:
                      </span>
                      <div className="flex flex-wrap gap-1.5">
                        {venue.amenities.slice(0, 3).map((amenity, i) => (
                          ...
                          >
                            ...
                            {amenity.split(" integrado")[0].split(" de ")[0].slice(0, 24)}...
                          </span>
                        ))}
                      </div>
                    </div>
                  ...
                  <div className="mt-7 pt-4 border-t border-gray-100 flex items-center justify-between">
                    ...
                    >
                      <span>Ver Detalles & Montajes</span>
